package net.co5mowulf.mccourse.block.entity;

import net.co5mowulf.mccourse.block.custom.GemEmpoweringStationBlock;
import net.co5mowulf.mccourse.recipe.GemEmpoweringRecipe;
...
public class GemEmpoweringStationBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    private boolean hasRecipe() {
        ...
        return canInsertAmountIntoOutputSlot(output.getCount())
                && canIntertItemIntoOutputSlot(output) && hasEnoughEnergyToCraft() && hasEnoughFluidToCraft();
    }
